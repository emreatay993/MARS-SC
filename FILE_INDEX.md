...
Generated: `2026-02-14 20:49:00`

## Scope

- Source root: `src/`
- Python modules indexed: `64`
- Total Python lines (physical): `20409`
...
| `src/core/data_models.py` | `src.core.data_models` | 556 | 10 | 0 | Data models for MARS-SC (Solution Combination). |
...
| `src/ui/display_tab.py` | `src.ui.display_tab` | 897 | 1 | 0 | Display tab: 3D visualization of FEA results (PyVista). |
...
| `src/ui/handlers/display_contour_sync_handler.py` | `src.ui.handlers.display_contour_sync_handler` | 472 | 0 | 0 | No module docstring. |
...
| `src/ui/handlers/display_interaction_handler.py` | `src.ui.handlers.display_interaction_handler` | 718 | 1 | 0 | Node interaction, picking, and hotspot analysis for the Display tab. |
...
| `src/ui/handlers/display_visualization_handler.py` | `src.ui.handlers.display_visualization_handler` | 632 | 1 | 0 | Visualization updates and rendering helpers for the Display tab. |
...
| `src/ui/handlers/solver_output_availability.py` | `src.ui.handlers.solver_output_availability` | 47 | 1 | 1 | Shared output-availability policy for solver-tab analyses. |
...
| `src/ui/handlers/solver_result_summary_handler.py` | `src.ui.handlers.solver_result_summary_handler` | 496 | 1 | 0 | UI result handling for analysis runs. |
| `src/ui/handlers/solver_run_execution_handler.py` | `src.ui.handlers.solver_run_execution_handler` | 295 | 2 | 0 | Execution concern for solver analysis runs. |
| `src/ui/handlers/solver_run_lifecycle_handler.py` | `src.ui.handlers.solver_run_lifecycle_handler` | 218 | 1 | 0 | Lifecycle/UI concern for solver analysis runs. |
...
| `src/ui/widgets/plotting.py` | `src.ui.widgets.plotting` | 1600 | 2 | 0 | Plotting widgets for MARS-SC (Solution Combination). |
