...
Generated: `2026-02-14 03:05:45`

## Scope

- Source root: `src/`
- Python modules indexed: `60`
- Total Python lines (physical): `22470`
...
| `src/ui/application_controller.py` | `src.ui.application_controller` | 268 | 2 | 0 | Main window for the MARS-SC: Solution Combination application. |
...
| `src/ui/builders/solver_ui.py` | `src.ui.builders.solver_ui` | 712 | 2 | 0 | Builds the Solver tab UI: RST inputs, combination table, output options, plasticity, console. |
...
| `src/ui/handlers/display_contour_sync_handler.py` | `src.ui.handlers.display_contour_sync_handler` | 472 | 1 | 0 | No module docstring. |
| `src/ui/handlers/display_contour_types.py` | `src.ui.handlers.display_contour_types` | 9 | 1 | 0 | No module docstring. |
| `src/ui/handlers/display_export_handler.py` | `src.ui.handlers.display_export_handler` | 795 | 1 | 0 | Export-related functionality for the Display tab. |
| `src/ui/handlers/display_file_handler.py` | `src.ui.handlers.display_file_handler` | 269 | 1 | 0 | File loading logic for the Display tab. |
...
| `src/ui/handlers/ui_state_handler.py` | `src.ui.handlers.ui_state_handler` | 399 | 1 | 0 | Tracks Solver tab UI state: what’s enabled/disabled, visible/hidden, based on user input. |
| `src/ui/solver_tab.py` | `src.ui.solver_tab` | 1530 | 3 | 0 | Solver tab: combine stress (and optionally forces/deformation) from two static RST files via linear combination coefficients. |
